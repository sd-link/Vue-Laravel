...
class LarapressMakeModuleCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'larapress:make:module
     ...
     * @var string
     */
    protected $description = 'Create a new Larapress module and bootstrap it';
