...
class LarapressModuleListCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $name = 'larapress:module:list';
     ...
     * @var string
     */
    protected $description = 'List all application modules in Larapress CMS';
