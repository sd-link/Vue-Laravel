<template>
    <form :action="url" class="vue-dropzone dropzone" :id="id" v-bind:style="{'height': height}">
        <slot></slot>
    </form>

    <!-- v-bind:class="['vue-dropzone dropzone', { 'flex': filesAdded != true }]" -->
</template>
...
<script>
    export default {
        ...
        computed: {
            languageSettings () {
                let defaultValues = {
                    dictDefaultMessage          : '<br>Drag and drop files here or click to upload',
