      ...
      <div class="el-picker-panel__body-wrapper">
        ...
        <div class="el-picker-panel__body">
          <div class="el-date-picker__time-header" v-if="showTime">
            ...
            <span class="el-date-picker__editor-wrap" v-clickoutside="handleClickOutside">
              <el-input
                ref="input"
...
<script type="text/babel">
  import DatePicker from 'element-ui/packages/date-picker/src/panel/date.vue';
    ...
    methods: {
      handleClickOutside() {
        if (this.timePickerVisible) {
          this.handleTimePick(null, false);
        }
      }
    }
  };
