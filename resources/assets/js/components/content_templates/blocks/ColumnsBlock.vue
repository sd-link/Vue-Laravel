            ...
            <div class="form-group">
                ...
                <div class="column-container" v-bind:style="columnsStyles">
                    <component
                        ...
                        v-on:remove="removeBlock(column.uniqueId)"
                        :key="column.uniqueId">
                    </component>
                </div>
        ...
        <modal ref="settingsModal" :title="modalTitle"
          ...
          :defaultHeight="modalDefaults.height">
            <div class="modal-body" slot="modal-body">
                ...
                <div class="form-group">
                    <div @click="columnsSettingsOpen=!columnsSettingsOpen" style="cursor: pointer; background: rgba(0,0,0, 0.2); padding: 5px 12px;">
                        <label style="margin: 0;">Columns Settings</label>
                        <span class="pull-right">
                            <i v-if="!columnsSettingsOpen" class="fa fa-arrow-circle-o-down" title="Show Css Settings" aria-hidden="true"></i>
                            <i v-else class="fa fa-arrow-circle-o-up" title="Hide Css Settings" aria-hidden="true"></i>
                        </span>
                    </div>

                    <div v-if="columnsSettingsOpen" class="form-sub-group">
                        <div class="form-group">
                            <label>Columns</label>
        ...
        methods: {
            ...
            addColumn() {
                if(this.columns.length < 6) {
                    let compName = 'ColumnBlockTemplate'
