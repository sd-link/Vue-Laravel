...
@section('content')
        ...
        @include('core/media/tags/add', ['url' => route('backend.media.gallery.tags.create')])
        @include('core/media/tags/edit', ['url' => route('backend.media.gallery.tags.update')])
        @include('core/media/tags/delete', ['url' => route('backend.media.gallery.tags.delete')])
                ...
                <div class="col-xs-12">
                  <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Gallery Tags</h3>
                        <div class="box-tools">
                            ...
                            <div id="content_display" ref="contentList" class="list page">
                                ...
                                <div id="tagsList">
                                    ...
                                    <div class="row" id="item{{ $tag->id }}">
                                        ...
                                        {{-- ACTIONS --}}
                                        <div class="column actions_column" data-id="{{ $tag->id }}" data-url="{{ route('backend.blog.tags.get', $tag->id)}}">
